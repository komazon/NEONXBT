...
class N2xbt():
    ...
    def _command_manager(self, task_queue, state):
        ...
        try:
            while True:
                ...
                if msg:
                    if msg["command"] == N2xbtCommands.CREATE_CONTROLLER:
                    ...
                    elif msg["command"] == N2xbtCommands.INPUT_MACRO:
                        cm.input_macro(
                            msg["arguments"]["controller_index"],
                            msg["arguments"]["macro"],
                            msg["arguments"]["macro_id"])
                    elif msg["command"] == N2xbtCommands.STOP_MACRO:
                        cm.stop_macro(
                            msg["arguments"]["controller_index"],
                            msg["arguments"]["macro_id"])
                    elif msg["command"] == N2xbtCommands.CLEAR_MACROS:
                        cm.clear_macros(
                            msg["arguments"]["controller_index"])
                    elif msg["command"] == N2xbtCommands.REMOVE_CONTROLLER:
    ...
    def macro(self, controller_index, macro, block=True):
        ...
        self.task_queue.put({
            "command": N2xbtCommands.INPUT_MACRO,
            "arguments": {
    ...
    def stop_macro(self, controller_index, macro_id, block=True):
        ...
        self.task_queue.put({
            "command": N2xbtCommands.STOP_MACRO,
            "arguments": {
                "controller_index": controller_index,
                "macro_id": macro_id,
            }
    ...
    def clear_macros(self, controller_index):
        ...
        self.task_queue.put({
            "command": N2xbtCommands.CLEAR_MACROS,
            "arguments": {
                "controller_index": controller_index,
            }
        })
    ...
    def create_controller(self, controller_type, adapter_path=None,
        ...
        try:
            ...
            self.task_queue.put({
                "command": N2xbtCommands.CREATE_CONTROLLER,
                "arguments": {
    ...
    def remove_controller(self, controller_index):
        ...
        self.task_queue.put({
            "command": N2xbtCommands.REMOVE_CONTROLLER,
            "arguments": {
                "controller_index": controller_index,
            }
        })
